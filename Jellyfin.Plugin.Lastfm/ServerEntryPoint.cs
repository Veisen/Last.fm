namespace Jellyfin.Plugin.Lastfm
{
    ...
    public class ServerEntryPoint : IServerEntryPoint
    {
        ...
        public ServerEntryPoint(ISessionManager sessionManager, IJsonSerializer jsonSerializer, IHttpClient httpClient, ILoggerFactory loggerFactory, IUserDataManager userDataManager)
        {
        ...
        private async void PlaybackStopped(object sender, PlaybackStopEventArgs e)
        {
            ...
            {
                _logger.LogInformation("No title present, aborting");
                return;
            }
        ...
        private async void PlaybackStart(object sender, PlaybackProgressEventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(item.Artists.FirstOrDefault()))
            {
                _logger.LogInformation("No artist present, aborting");
                return;
            }
